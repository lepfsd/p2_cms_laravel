...
@section('header')
	<!-- Header -->
    <header class="header text-white h-fullscreen pb-80" style="background-image: url({{Gravatar::src($post->name)}});" data-overlay="9">
				...
				<script>
					...
					*  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
					...
					(function() { // DON'T EDIT BELOW THIS LINE
						...
						s.src = 'https://p2-cms-laravel.disqus.com/embed.js';
